...
import neat.experiments.template.config as config
from neat.visualize import draw_net
from tqdm import tqdm

import neat.experiments.template.default_kwargs as default_kwargs
...
min_num_generations = 1000


for i in tqdm(range(1)):
    neat = pop.Population(config.TemplateConfig(*default_kwargs))
